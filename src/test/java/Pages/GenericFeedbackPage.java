...
public class GenericFeedbackPage extends ChromeSetup {
    ...
    public void Generic_Feedback () throws InterruptedException
    {
       ...
       // WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
        ...
        try
        {
            Gen_HC_Feedback = Wait.WaitForWebElement().until(ExpectedConditions.visibilityOf(feedbackPageObjects.Generic_Feedback_Content)).isDisplayed();
        }
        catch (Exception e)
        {
        ...
        if (Gen_HC_Feedback)
        {
            ...
            {
                Wait.WaitForWebElement().until(ExpectedConditions.visibilityOf(feedbackPageObjects.Overall_HC_Feedback)).click();
                ...
                Wait.WaitForWebElement().until(ExpectedConditions.visibilityOf(feedbackPageObjects.GenericFeedbackSubmit_Btn)).click();
