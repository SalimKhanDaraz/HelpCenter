...
public class CategorySliderPage extends ChromeSetup {
    ...
    {
        Wait.WaitForWebElement().until(ExpectedConditions.visibilityOf(categorySliderPageObjects.Category)).click();
    }
    ...
    public void CategorySlide () throws InterruptedException {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            Wait.WaitForWebElement().until(ExpectedConditions.visibilityOf(categorySliderPageObjects.Categories));
    ...
    public void CategorySliderSpot () throws InterruptedException {
        ...
        Thread.sleep(1500);
        Wait.WaitForWebElement().until(ExpectedConditions.visibilityOf(categorySliderPageObjects.PromotionCategory)).click();
        ...
        for (int i = 0; i < 8; i++) {
            ...
            SliderSpot = driver.findElements(By.xpath("//*[@class=\"Ve1nldNCvVN1B5F6XLta\"]//div"));
            Wait.WaitForWebElement().until(ExpectedConditions.visibilityOf(categorySliderPageObjects.Categories)).click();
