...
public class GreetingsPage extends ChromeSetup {
    ...
    public void Greetings () throws InterruptedException {
        ...
        try
        {
            Content1 = Wait.WaitForWebElement().until(ExpectedConditions.visibilityOf(greetingsPageObjects.Greeting_Section)).isDisplayed();
            Content2 = Wait.WaitForWebElement().until(ExpectedConditions.visibilityOf(greetingsPageObjects.Greeting_Content)).isDisplayed();
