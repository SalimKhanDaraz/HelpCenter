...
public class FeedbackWithNoPage extends ChromeSetup {
    ...
    public void Submit_Feedback_No () throws InterruptedException {
        ...
        try {
            Thread.sleep(1500);
            Wait.WaitForWebElement().until(ExpectedConditions.visibilityOf(feedbackPageObjects.Feedback_No)).click();
        ...
        Thread.sleep(1500);
        Wait.WaitForWebElement().until(ExpectedConditions.visibilityOf(feedbackPageObjects.Feedback_Option1)).click();

        Thread.sleep(1500);
        Wait.WaitForWebElement().until(ExpectedConditions.visibilityOf(feedbackPageObjects.Feedback_Submit_Button)).click();

        Thread.sleep(1500);

        try
        {
            HC_FeedbackThankYou = Wait.WaitForWebElement().until(ExpectedConditions.visibilityOf(feedbackPageObjects.Feedback_ThankYou)).isDisplayed();
        }
        catch (Exception e)
        {
        ...
        Wait.WaitForWebElement().until(ExpectedConditions.visibilityOf(feedbackPageObjects.CloseGenericFeedbackForm)).click();
        //Thread.sleep(100);
